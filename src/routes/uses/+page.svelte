...
<svelte:head>
    <title>Rich Perez - Uses - Web Developer</title>
</svelte:head>
...
<section class="mx-auto max-w-2xl flex flex-col gap-2">
    ...
    <ul class="list-disc flex flex-col gap-2">
        ...
        <li>For my pure frontend joys I use <a href="https://kit.svelte.dev" target="_blank">SvelteKit</a> with either vanilla <a href="https://www.w3.org/Style/CSS/Overview.en.html" target="_blank">CSS</a> or <a href="https://tailwindcss.com" target="_blank">Tailwind</a> & <a href="https://daisyui.com" target="_blank">DaisyUI</a> to make everything look nice.</li>
        <li>For my API testing I really enjoy <a href="https://www.postman.com" target="_blank">Postman</a>. It's practically a standard at this point and very easy to use.</li>
        <li>For the occasional mobile app development my editor is of course <a href="https://developer.apple.com/xcode/" target="_blank">Xcode</a>. The <a href="https://www.swift.org" target="_blank">Swift language</a> is really a joy to use.</li>
    </ul>
</section>
