...
<svelte:head>
    <title>Rich Perez - Wrestling - Web Developer</title>
</svelte:head>

<section class="mx-auto max-w-2xl font-mono text-xl md:text-2xl text-center py-10">
    <PageHeading label="Wrestling" />
    <p>
        I've been a big fan of pro wrestling since I was kid. From the days of Hulk Hogan to Steve Austin & The Rock and today with our Tribal Chief Roman Reigns. 
    </p>
</section>
...
<section class="mx-auto max-w-2xl flex flex-col gap-2 mt-10">
    ...
    <ol class="px-6 flex flex-col gap-2 list-decimal">
        ...
        <li>Steve Austin vs Kevin Owens (WrestleMania 38) - <a href="https://www.youtube.com/watch?v=Wukhr0uKgIE" target="_blank">Watch</a></li>
        <li>The Wyatt Family vs The Shield (Elimination Chamber 2014) - <a href="https://www.youtube.com/watch?v=oxdKQRPIjgw" target="_blank">Watch</a></li>
    </ol>
</section>