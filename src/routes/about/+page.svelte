...
>
    ...
    <p>
        My name is <strong class="font-black text-white">Rich Perez</strong> and
        I am a Full-Stack Developer. I have built websites, CMS, and REST APIs for
...
<section class="mx-auto max-w-2xl flex flex-col gap-2 mt-10">
    ...
    <ul class="px-4 list-disc flex flex-col gap-2">
        ...
        <li>
            <a href="https://www.phpweekly.com" target="_blank">PHP Weekly</a>
        </li>
        <li>
    ...
    <ul class="px-4 list-disc flex flex-col gap-2 mt-4">
        ...
        <li>
            <a href="https://a11yweekly.com" target="_blank">A11y Weekly</a>
        </li>
    </ul>
</section>
