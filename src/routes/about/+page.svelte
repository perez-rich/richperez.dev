...
<section class="mx-auto max-w-2xl font-mono text-xl md:text-2xl text-center py-10">
	...
	<p>
		My name is <strong class="font-black text-white">Rich Perez</strong> and I am a Full-Stack Developer. I have
		built websites, CMS, and REST APIs for large and small companies.
	</p>
</section>
...
<section class="mx-auto max-w-2xl flex flex-col gap-2">
	...
	<ul class="px-4 list-disc flex flex-col gap-2">
		...
		<li>Listen to music with me on <a href="https://music.apple.com/profile/imperez" target="_blank">Apple Music</a>
		</li>
	</ul>
</section>
